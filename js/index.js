...
var _noteList = __webpack_require__(77);
...
function notes() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _noteList2.default)();
    var action = arguments[1];

    if (action.type === "ADD_NOTE") {
        return [].concat(_toConsumableArray(state), [action.payload]);
    } else if (action.type === 'DELETE_NOTE') {
        return state.filter(function (notes) {
            return notes.id !== action.payload;
        });
    } else {
        var localNotes = JSON.parse(localStorage.getItem('note'));
        if (localNotes) {
...
var _NoteEditor = __webpack_require__(74);

var _NoteEditor2 = _interopRequireDefault(_NoteEditor);

var _NoteGrid = __webpack_require__(75);
...
var NoteEditor = function (_Component) {
    ...
    function NoteEditor() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = NoteEditor.__proto__ || Object.getPrototypeOf(NoteEditor)).call.apply(_ref, [this].concat(args))), _this), _this.addNote = function () {
            console.log('---', _this.text.value);
            _this.props.onAddNote(_this.text.value);
            _this.text.value = '';
...
exports.default = (0, _reactRedux.connect)(function (state) {
    ...
    return {
        onAddNote: function onAddNote(newNote) {
            var payload = {
                id: Date.now(),
                text: newNote,
                color: generateColor()
...
var _notes = __webpack_require__(30);
...
var Masonry = __webpack_require__(78);
...
var NoteGrid = function (_Component) {
    ...
    function NoteGrid() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = NoteGrid.__proto__ || Object.getPrototypeOf(NoteGrid)).call.apply(_ref, [this].concat(args))), _this), _this.delNote = function (el) {
            console.log('---', el.id);
            _this.props.onDeleteNote(el);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(NoteGrid, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'note-grid', ref: 'all' },
                this.props.notes.map(function (note) {
                    return _react2.default.createElement(
                        _Note2.default,
                        { key: note.id, color: note.color, onDelete: _this2.delNote.bind(null, note) },
                        note.text
                    );
                })
            );
...
exports.default = (0, _reactRedux.connect)(function (state) {
    ...
    return {
        onDeleteNote: function onDeleteNote(el) {
            var payload = el.id;
...
exports.default = function () {
    return [{
        id: 1,
        text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur culpa deserunt facilis, incidunt ipsum nisi non officiis quis, quisquam saepe similique veniam veritatis. At illo ipsam nemo qui quo repellat?',
        color: '#ff97ab'
    }, {
        id: 2,
        text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur culpa deserunt facilis, incidunt ipsum nisi non officiis quis, quisquam saepe similique veniam veritatis.',
        color: '#fff0a1'
    }, {
        id: 3,
        text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur culpa deserunt facilis, incidunt ipsum nisi non officiis quis.',
        color: '#aab8ff'
    }, {
        id: 4,
        text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur culpa deserunt facilis, incidunt ipsum nisi non officiis quis, quisquam saepe similique veniam veritatis. At illo ipsam nemo qui quo repellat?',
        ...
        id: 5,
        text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur culpa deserunt facilis, incidunt ipsum nisi.',
        color: '#abffac'
    }, {
        id: 6,
        text: 'Consequatur culpa deserunt facilis, incidunt ipsum nisi.',
        color: '#abffac'
    }, {
        id: 7,
        text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur culpa deserunt facilis, incidunt ipsum nisi.',
        ...
        id: 8,
        text: 'Consectetur adipisicing elit. Consequatur culpa deserunt facilis, incidunt ipsum nisi.',
        color: '#abffac'
    }];
};
